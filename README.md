# SCC Inspector for Notepad++ (archived)

> **Migrated to VS Code** — This project has been superseded by **[SCC Inspector for VS Code](https://github.com/dkneeland/scc-inspector)**, a full rewrite as a VS Code extension with Language Server Protocol support. This repository is kept for historical reference only.
...
- Check existing [Issues](https://github.com/dkneeland/scc-inspector-npp/issues)
